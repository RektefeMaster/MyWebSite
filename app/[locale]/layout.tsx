 ...
 *
 *  Ölçüldü/dar bant: perde 1.3–2MB video + 10sn scroll kilidi demek. Save-Data
 *  açıkken veya 2g bağlantıda bu, siteyi "açılmıyor" gibi gösteriyor — o
 *  durumda perde reduced-motion gibi tamamen atlanır ve ziyaretçi doğrudan
 *  hero'ya iner. `?intro` ile zorlama yine çalışır.
 */
