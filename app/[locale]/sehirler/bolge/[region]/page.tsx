    ...
    <>
      ...
      <div className="bg-background px-5 py-16 md:px-10 md:py-24">
        <div className="mx-auto max-w-7xl">
            ...
            {content.sections.map((section, index) => (
              <Reveal key={section.heading} delay={index * 30}>
                <section className="grid grid-cols-12 gap-x-4 gap-y-5 border-t border-foreground/25 py-10 md:gap-x-6 md:py-14">
                  ...
                  <h2 className="font-display type-display col-span-10 max-w-[18ch] text-[clamp(1.15rem,6.5vw,3.5rem)] leading-[1.46] tracking-[-0.03em] sm:text-[clamp(2rem,3.5vw,3.5rem)] md:col-span-4">
                    {section.heading}
                  </h2>
          ...
          <Reveal>
            <h2 className="font-display type-display mt-16 max-w-[18ch] text-[clamp(1.15rem,6.5vw,3.5rem)] leading-[1.46] tracking-[-0.03em] sm:text-[clamp(2rem,3.5vw,3.5rem)] md:mt-24">
