  ...
  return (
    <section className="bg-background px-5 pb-16 md:px-10 md:pb-24">
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <h2 className="font-display type-display max-w-[18ch] text-[clamp(1.15rem,6.5vw,3.5rem)] sm:text-[clamp(2rem,3.5vw,3.5rem)] leading-[1.46] tracking-[-0.03em]">
            {heading}
          </h2>
        </Reveal>
        <ul className="mt-10 border-t border-foreground/25">
          {items.map((item, index) => (
            <li key={item.href}>
              ...
              >
                <span className="col-span-2 font-mono text-[10px] font-bold tabular-nums tracking-[0.16em] text-foreground/40 md:col-span-1">
