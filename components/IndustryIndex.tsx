        ...
        {items.map((item, index) => (
          <Reveal key={item.slug} delay={index * 30}>
            ...
            >
              ...
              <span
                aria-hidden
                className="col-span-12 text-right text-lg text-foreground/40 transition-transform motion-reduce:transition-none md:col-span-1 md:col-start-12 md:self-center [@media(hover:hover)_and_(pointer:fine)]:group-hover:translate-x-1"
              >
                →
              </span>
            </Link>
