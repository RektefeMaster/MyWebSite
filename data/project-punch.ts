...
const projectPunch: Record<string, Record<string, string>> = {
  tr: {
    ...
    mizan: "Tedavi anlatımını ilk danışmanlıkla buluşturan klinik sitesi.",
  ...
  en: {
    ...
    mizan: "A clinic site connecting treatment information with consultation.",
  ...
  es: {
    ...
    mizan: "Tratamientos y espacio de la clínica antes de la consulta.",
  ...
  de: {
    ...
    mizan: "Behandlungen und Praxisräume vor der ersten Beratung.",
