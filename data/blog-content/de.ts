...
const content: Record<string, BlogArticle> = {
  "hotel-website-design": {
    ...
    excerpt:
      "Was eine Hotel-Website vor der Atmosphäre leisten muss: URLs je Zimmertyp, ein Satz zur Lage, ein Weg, der den Gast nicht in eine Engine mit schlechterem Preis kippt.",
    lead: "Ein Hotel-Theme legt drei Adjektive über einen Slider. Der Gast braucht trotzdem Zimmertypen, wo das Haus steht, und wie er schreibt oder bucht, ohne den Tarif zu verlieren. METEK Digital behandelt die Hospitality-Site als Hausdokument. Casa Aurelia Roma und Altitude Residences sind die öffentlichen Tempo-Beispiele.",
    imageAlt: "Hotelzimmerfoto neben einem Wireframe der Zimmertypen",
    sections: [
      {
        heading: "Jeder Zimmertyp bekommt eine Adresse",
        paragraphs: [
          "Suite und Hofzimmer sind verschiedene Suchen und verschiedene Mails an die Rezeption. Eine 'Unterkünfte'-Seite verschwendet beides. Title und H1 sollen das Zimmer so nennen, wie ein Gast tippt.",
          "Fotografie muss Maßstab und Tageslicht zeigen, nicht nur eine gestylte Ecke. Beschriften Sie, was zu sehen ist. 'Luxusaufenthalt' neben Stock-Interieur hilft niemandem, zwei Häuser in derselben Straße zu vergleichen.",
        ],
      },
      {
        heading: "Direktweg und Engine",
        paragraphs: [
          "Nehmen Sie Direktbuchungen an, sammeln Sie Daten, Belegung und Zweck und übergeben Sie das der Rezeption oder der Engine, die Sie wirklich nutzen. Ein Widget ohne Haus-Text sieht aus wie jedes andere Hotel.",
          "Bestätigt WhatsApp oder E-Mail den Aufenthalt noch, sagen Sie das und bauen Sie den Weg. Sofort-Checkout vorzutäuschen, während ein Mensch genehmigt, erzeugt Doppelbuchungen.",
        ],
      },
      {
        heading: "Stadtbegriffe stehen auf der Lage-Seite",
        paragraphs: [
          "Viertelsprache gehört auf eine Seite, deren Gegenstand die Lage ist, nicht in jede Überschrift. Ein Boutique-Haus in Rom und ein Residence-Produkt teilen keinen Text, nur weil beide Betten haben.",
          "Suchen Gäste in mehr als einer Sprache, schreiben Sie jedes Locale. Die englische Zimmerseite maschinell zu übersetzen, rankt im zweiten Markt für nichts.",
        ],
      },
      {
        heading: "Relaunch braucht die alten Zimmer-URLs",
        paragraphs: [
          "Rankt die aktuelle Site schon für den Hotelnamen oder einen Zimmertyp, mappen Sie diese Adressen vor dem Launch. Slugs ohne 301 ändern, übergibt die Geschichte an 404.",
          "Technisches SEO heißt hier Titles, Zimmer-URLs, Canonicals, Sitemap und diese Redirect-Liste. Rangversprechen gehören nicht zur Arbeit. Die Hospitality-Branchenseite ist die Leistungsfläche, wenn Sie einen Build briefen.",
        ],
      },
    ],
  },
  "manufacturing-company-website": {
    title: "Website für Fertigungsunternehmen: Katalog, Specs, Anfrage",
    excerpt:
      "Einkäufer brauchen Produktfamilien, genug Spezifikation für ein Gespräch und ein Formular, das der Vertrieb öffnet. Eine Broschüren-Startseite ist das nicht.",
    lead: "Eine Werkseite nützt wenig, wenn sie wie die Broschüre eines Unternehmens wirkt, das noch per PDF anbietet. Die brauchbare Fläche nennt die Linie, zeigt Finish oder Maß und schickt eine vollständige Anfrage. Wholesale Cabinet Creations ist das nächste öffentliche Beispiel im Portfolio.",
    imageAlt: "Datenblatt neben einem Anfrageformular auf dem Laptop",
    sections: [
      {
        heading: "Ersten Screen für den Einkäufer schreiben",
        paragraphs: [
          "Händler und Bauunternehmen prüfen, ob die Linie existiert, ob eine Vorgabe veröffentlicht ist, ob ein Termin denkbar ist. Firmengeschichte darf tiefer stehen. Zertifikate neben das Produkt, auf das sie zutreffen.",
          "Liegen diese drei Fakten hinter vier Klicks und einem allgemeinen Kontaktfeld, schreiben sie jemanden, der sie schon ausweist.",
        ],
      },
      {
        heading: "Eine Familie, eine URL",
        paragraphs: [
          "Großhandel Küchenmöbel und Einbauschränke nach Maß teilen sich keine dünne Startseite. Jede Familie braucht Gegenstand, Title, H1 und Links von verwandten Seiten.",
          "Erfinden Sie keinen Warenkorb, wenn Aufträge weiter über Menschen laufen. Katalog plus Anfrage ist das ehrliche Produkt. Shop ist anderer Umfang, wenn Preise und Bestand real sind.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Der Beitrag zu B2B-Anfrageformularen listet die Felder auf Fertigungsformularen. Lesen Sie ihn, bevor Sie einen Verbraucher-Kontaktblock kopieren.",
        ],
      },
      {
        heading: "Wer pflegt den Katalog nach dem Launch",
        paragraphs: [
          "Ändern sich Lieferzeiten und Finishes, gehört ein Panel mit genau diesen Feldern in dieselbe Lieferung. Ein hübscher Katalog, den niemand editiert, ist nach einer Saison veraltet.",
          "Start mit Familien, Käuferrolle, Sprachen und ob eine Live-URL ersetzt wird. Die Fertigungs-Branchenseite ist die Leistungsfläche, wenn Sie den Umfang setzen wollen.",
        ],
      },
    ],
  },
  "local-seo-for-service-businesses": {
    ...
    sections: [
      {
        heading: "Den Job auf der eigenen Seite nennen",
        paragraphs: [
          "Polster-, Matratzen- und Büroreinigung sind verschiedene Queries. Sie können ein visuelles System teilen. Sie dürfen nicht in einem Absatz auf Start sitzen. Jede Leistung braucht Title, H1, Beleg und ein Formular, das den Job benennt.",
          "Preisrahmen nur veröffentlichen, wenn er stimmt und gepflegt wird. Erfundene 'ab 99'-Banner trainieren den falschen Anrufer.",
        ],
      },
      {
        heading: "Gebietsseiten nur, wo Sie hinfahren",
        paragraphs: [
          "Zehn kopierte Orte mit getauschtem Namen sind schlechter als drei genaue. Schreiben Sie Anfahrt, Parken, Gebäudetyp, Reaktionszeit. Dienen Sie den Ort nicht, veröffentlichen Sie die URL nicht.",
          "Interne Links sollen verwandte Jobs und wirklich abgedeckte Gebiete verbinden. Verwaiste Gebietsseiten wirken wie ein Generator, auch wenn der Rest ehrlich ist.",
        ],
      },
      {
        heading: "Das Profil ist nicht die Website",
        paragraphs: [
          "Das Google-Unternehmensprofil schickt Menschen aus dem Map-Pack. Die Website muss die Leistungsquery beantworten und die Anfrage annehmen. Kategorien und Fotos im Profil müssen zu den Seiten passen.",
          "Platz eins bei Maps verkaufen wir nicht. Wir bauen indexierbare Seiten und halten Name, Adresse, Telefon gleich. Der Pack-Rang hängt an Signalen, die wir nicht steuern.",
        ],
      },
      {
        heading: "Flags vor dem Launch",
        paragraphs: [
          "Eigene Titles je Leistung, crawlbares HTML, Canonicals, Sitemap, NAP gleich dem Profil, LocalBusiness ohne Fake-Reviews. Beim Relaunch jede alte Leistungs- und Gebiets-URL umleiten. Diese Seiten sind oft das einzige, was ein kleiner Betrieb besitzt.",
          "Laufen Aufträge über WhatsApp, übergibt der Button Leistung und Gebiet in die Nachricht. Ein generischer Chatbot auf einer Einzelseite ist diese Arbeit nicht. Die Branchenseite lokale Dienste ist die kommerzielle Fläche.",
        ],
      },
    ],
  },
  "schema-markup-for-business-websites": {
    title: "Schema-Markup für Unternehmenswebsites (ohne Theater)",
    excerpt:
      "JSON-LD soll Fakten wiederholen, die schon auf der Seite stehen: Organisation, Leistungen, FAQ, Artikel. Fake-Sterne und erfundene Büros laden eine manuelle Maßnahme ein.",
    lead: "Schema ist ein Vokabular, das Maschinen teilen. Es lässt eine dünne Seite nicht ranken. Es hilft Crawler oder Antwort-Engine, Organisation, Seitentyp und die Fragen zu benennen, die Sie im HTML schon beantwortet haben. METEK markiert diese Typen auf der Studio-Site und auf Mandanten-Builds, wenn die Fakten existieren.",
    imageAlt: "Gedruckter JSON-LD-Ausschnitt neben einem FAQ im Browser",
    sections: [
      {
        heading: "Markieren, was der Besucher schon liest",
        paragraphs: [
          "Organization oder ProfessionalService mit echtem Namen, URL, E-Mail, Telefon, Land. Person für eine genannte Gründerin oder einen Gründer. WebSite für das Locale. BreadcrumbList für den Pfad. FAQPage nur bei sichtbaren Fragen. BlogPosting auf Artikeln. Service auf einer Leistungs-URL.",
          "Steht die Tatsache nicht auf der Seite, gehört sie nicht ins JSON-LD. Erfundene Durchschnittsnoten und Sterne sind ein häufiger Weg, ignoriert oder abgestraft zu werden.",
        ],
      },
      {
        heading: "LocalBusiness ist eine Ortsbehauptung",
        paragraphs: [
          "Nutzen Sie es, wenn Sie ein Gebiet oder ein Premises vertreten und NAP zum Google-Profil passt. Kleben Sie keinen LocalBusiness-Block auf ein rein remote Studio, das eine Stadt zur Dekoration nennt.",
          "areaServed können Länder sein, aus denen Sie wirklich Arbeit annehmen. Es ist keine Wunschliste von Büros.",
        ],
      },
      {
        heading: "HowTo und DefinedTermSet haben eine Aufgabe",
        paragraphs: [
          "HowTo gehört auf eine echte Checkliste, nicht auf eine Verkaufsseite im Schritt-Kostüm. DefinedTermSet gehört ins Glossar. Jeden Artikel als HowTo zu stopfen, lässt Rich Results das Vertrauen verlieren.",
          "Diese Studio-Site nutzt HowTo auf wenigen Checklisten-Beiträgen und DefinedTermSet im Glossar. Das ist das Muster, das wir auf Mandanten-Sites kopieren, wenn der Inhalt passt.",
        ],
      },
      {
        heading: "Den Graph vor dem Launch testen",
        paragraphs: [
          "Live-URL in Googles Rich-Results-Test einfügen, Fehler beheben. Kanonische URL im Graph muss zur Seite passen. FAQ-Antworten dieselben Sätze wie im HTML.",
          "Schema ist Teil des technischen SEO in der Website-Lieferung, kein Ranking-Paket. Das Glossar definiert die Nachbarbegriffe. Die SEO-Leistungsseite sagt, was im Build enthalten ist.",
        ],
      },
    ],
  },
  "wordpress-vs-custom-website": {
    ...
    excerpt:
      "WordPress ist ein Produkt mit Themes und Plugins. Eine individuelle Site ist eine Oberfläche für die Marke, mit Panel nur wenn das Team bestimmte Felder nutzt. Das sind verschiedene Käufe.",
    lead: "Die Gabelung ist nicht 'modern gegen alt'. Sie kaufen ein CMS-Ökosystem oder Sie beauftragen eine Oberfläche. METEK verkauft Marktplatz-Themes nicht als Custom-Arbeit. Brauchen Sie WordPress, ist das ein anderer Anbieter-Typ. Brauchen Sie Seiten und Felder, die zum Betrieb passen, ist das der Custom-Weg.",
    imageAlt: "Zwei Papierstapel, Theme-Optionen und Seitenkarte",
    sections: [
      {
        heading: "Was Sie wirklich kaufen",
        paragraphs: [
          "WordPress gibt einen großen Plugin-Markt, einen vertrauten Editor und eine Update-Last, die nicht endet. Ein gekauftes Möbel- oder Hotel-Theme bleibt dieses Produkt mit neuen Farben.",
          "Individuell heißt: Layouts für das Angebot, Code bei der Übergabe Ihrer, ein Content-Panel nur für die Objekte, die Sie genannt haben: Kollektionen, Zimmer, Lieferzeiten. Es gibt kein Plugin-Verzeichnis, das ein fehlendes Objekt überklebt.",
        ],
      },
      {
        heading: "Wann WordPress die ehrliche Wahl ist",
        paragraphs: [
          "Ein blog-lastiger Verlag, ein Team schon auf Gutenberg, eine Site deren Hauptjob häufige Beiträge sind. Auch ein Budget, das Custom-Design nicht trägt und trotzdem live muss.",
          "Dann jemanden beauftragen, der Updates, Backups und die Theme-Grenzen trägt. Zahlen Sie keine Custom-Preise für eine Theme-Installation.",
        ],
      },
      {
        heading: "Wann individuell die ehrliche Wahl ist",
        paragraphs: [
          "Angebotsgeführte Fertigung, Hotel mit Zimmertyp-URLs, lokaler Leistungs-Seitensatz, mehrsprachiger Markt mit nativem Text: diese Jobs kämpfen mit einem generischen Theme. Das Geld landet in Plugins und Workarounds oder in den Seiten.",
          "Individuell nutzt intern trotzdem Vorlagen. Das Artikel-Layout darf sich wiederholen. Der Unterschied ist Eigentum, nicht Abwesenheit von Muster.",
        ],
      },
      {
        heading: "Fragen, die das Angebot trennen",
        paragraphs: [
          "Wer editiert nach dem Launch, welche Felder, wem gehört Hosting, was passiert mit alten URLs, wer schreibt Titles. Das fragen Sie jeden Anbieter. Die Antworten trennen eine Website von einem visuellen Refresh.",
          "Vergleichen Sie Agenturen, ist der Beitrag zur Agenturwahl die Geschwister-Checkliste. Custom gegen Template deckt Marktplatz-Skins ab. Dieser Text ist die CMS-Gabelung.",
        ],
      },
    ],
  },
  "b2b-website-quote-requests": {
    title: "B2B-Anfrageformulare, die der Vertrieb öffnet",
    excerpt:
      "Name, E-Mail und Nachrichtenfeld erzeugen Ausschuss. Fertigungs- und Handelsseiten brauchen Projekttyp, Menge, Region, Zeitfenster und Dateien. Der Datensatz muss dort landen, wo der Vertrieb schon arbeitet.",
    lead: "Ein Angebotsformular gehört zum Vertriebspult, nicht in ein Kontakt-Widget. Tippt das Büro jede Einsendung in eine Tabelle, hat die Site die Arbeit nicht beendet. METEK plant die Felder aus dem Freitags-Workaround und schickt den Datensatz an E-Mail oder ein Panel, das das Team öffnet.",
    imageAlt: "Anfragefelder für Projekttyp und Menge auf einem Desktop",
    sections: [
      {
        heading: "Vom letzten verlorenen Request starten",
        paragraphs: [
          "Fragen Sie den Vertrieb, was er bei den letzten drei Anfragen nachfassen musste: Lieferort fehlt, keine Menge, Foto eines fremden Datenblatts. Diese Lücken werden Pflichtfelder oder Datei-Upload.",
          "Ein Verbraucher-'wie können wir helfen'-Kasten trainiert den falschen Besucher. Trade-Einkäufer überspringen ein Formular, das wie ein Newsletter-Signup wirkt. Sie füllen eines, das wie ein Auftragsticket wirkt.",
        ],
      },
      {
        heading: "Felder auf einem Fertigungsformular",
        paragraphs: [
          "Projekttyp oder Produktfamilie, Menge oder Raumzahl, Lieferregion, Zieldatum, Pläne falls vorhanden, 'wie gehört' nur wenn Sie es lesen. Telefon nützt, wenn das Pult noch anruft.",
          "Fragen Sie keine Budgetzahl, wenn Sie sie nicht zum Qualifizieren nutzen. Optionale Felder, die niemand ins CRM mappt, sind Dekor.",
        ],
      },
      {
        heading: "Wohin der Datensatz geht",
        paragraphs: [
          "E-Mail reicht, wenn das Volumen klein ist und eine Person den Posteingang hält. Panel oder CRM-Übergabe gehört in den Umfang, wenn mehrere die Queue bearbeiten oder der öffentliche Katalog im selben System gepflegt wird.",
          "WhatsApp kann ein vorausgefülltes Ticket tragen, wenn das Pult so antwortet. Ein Chatbot, der denselben Datensatz nicht anlegt, ist ein zweiter Posteingang, keine Automatisierung.",
        ],
      },
      {
        heading: "Suche braucht weiter die Produktseiten",
        paragraphs: [
          "Ein perfektes Formular auf einer Startseite, die die Produktfamilie nie nennt, holt den Besucher nicht. Katalog-URLs und Formular arbeiten als Paar. Die Fertigungs-Branchenseite und der Fertigungs-Website-Beitrag beschreiben dieses Paar.",
          "Im Brief die letzten drei echten Anfragen (bereinigt) und wohin sie hätten landen sollen. Das reicht für die Feldliste.",
        ],
      },
    ],
  },
  "how-to-choose-web-design-agency": {
    title: "Webdesign-Agentur auswählen, ohne zu raten",
    excerpt:
      "Checkliste für den Agenturvergleich: Umfang, Individualarbeit gegen Theme, SEO im Bau, Inhaltsverantwortung und wer nach dem Launch bleibt.",
    lead: "Eine Agentur zu wählen fällt leichter, wenn dieselbe Arbeit verglichen wird. Bitten Sie jedes Studio, Seiten, Besucherhandlung, technisches SEO und die Bearbeitung nach dem Launch zu beschreiben. Die brauchbaren Unterschiede stehen in diesen Antworten, nicht in einem Moodboard oder einem Versprechen auf Platz eins.",
    imageAlt: "Notizbuch mit Agenturvergleich neben einem Laptop",
    sections: [
      {
        heading: "Schreiben Sie die Aufgabe, bevor Sie Angebote sammeln",
        paragraphs: [
          "Nennen Sie Zielgruppe, die Handlung, die die Site tragen muss, Sprachen und ob es die erste Site oder ein Rebuild ist. Panel, Chatbot oder Migration gehören dazu. Dieser Absatz lässt jede Anbieterin dieselbe Arbeit kalkulieren.",
          "Schicken Sie nur „wir brauchen eine neue Website“, erhalten Sie unvergleichbare Zahlen. Ein Angebot versteckt ein Theme ohne Redirects. Ein anderes enthält eigenes Design, Metadaten und ein Panel. Die Lücke ist Umfang, kein Rätsel.",
        ],
      },
      {
        heading: "Fragen Sie, was „individuell“ heißt",
        paragraphs: [
          "Individuell heißt: Interface wird für die Marke gestaltet und gebaut. Ein Marketplace-Theme mit neuen Farben ist ein anderes Produkt. Fragen Sie, welche Layouts einzigartig sind, welche Seiten ein Template teilen und ob der Code nach der Übergabe Ihnen gehört.",
          "METEK Digital verkauft fertige Themes nicht als Individualarbeit. Kann ein Anbieter kein Projekt zeigen, in dem öffentliche Site und Betriebswerkzeuge gemeinsam geplant wurden, ist das Information.",
        ],
      },
      {
        heading: "Suche und URLs in den Vergleich",
        paragraphs: [
          "Fragen Sie, wer Title-Tags schreibt, wie die XML-Sitemap entsteht und was im Rebuild mit alten Adressen passiert. Technisches SEO gehört zur Website-Lieferung. Rankings sind kein Paket, das jemand ehrlich garantieren kann.",
          "Ein Rebuild ohne Redirect-Karte verwirft Seiten, die Suchmaschinen schon kennen. Erscheinen Sie bereits zu nützlichen Anfragen, gehört diese Zuordnung in den Vorschlag.",
        ],
      },
      {
        heading: "Wer bleibt nach dem Launch",
        paragraphs: [
          "Klären Sie, wem Domain, Hosting, Messung und Quellcode gehören. Klären Sie, welche Felder das Team ohne Entwicklung pflegt. Klären Sie, wie Mängel der vereinbarten Lieferung von neuen Wünschen getrennt werden.",
          "Eine verantwortliche Delivery-Lead von der Klärung bis zum Launch ist klarer als ein namenloses „Team“, das bei jedem Anruf wechselt. Fragen Sie nach dem Namen, der bei der Übergabe noch da ist.",
        ],
      },
      {
        heading: "Lesen Sie das Portfolio als Beleg",
        paragraphs: [
          "Suchen Sie Geschäfte, die verkaufen wie Sie: Angebot, Buchung, Katalog, lokale Leistungsseiten. Ein hübsches Screenshot ohne das gelöste Problem ist Dekoration.",
          "Wenn Sie soweit sind, schicken Sie METEK Digital diesen Aufgabenabsatz. Wir sagen, ob die Arbeit passt und welcher Leistung sie ähnelt: Website, Panel, Automatisierung oder eine Mischung.",
        ],
      },
    ],
  },
  "multilingual-website-seo": {
    title: "Mehrsprachiges SEO: hreflang, Texte, ein Thema je URL",
    excerpt:
      "Wie mehrsprachiges SEO für eine Unternehmenssite läuft: native Texte je Markt, hreflang, Canonicals und warum eine übersetzte Keyword-Liste keine Strategie ist.",
    lead: "Eine mehrsprachige Site ist eine Menge Seiten mit Sprache und Markt, kein Knopf, der Wörter tauscht. Suchmaschinen brauchen je URL eine Sprachangabe, Verweise auf die Geschwister und Texte für die Anfragen dieses Marktes. Hreflang ist der technische Handschlag. Das Schreiben vor Ort ist die Substanz.",
    imageAlt: "Vier Sprachlabel neben Website-Ausdrucken",
    sections: [
      {
        heading: "Eine URL, eine Sprache, eine Aufgabe",
        paragraphs: [
          "Liefern Sie Englisch und Deutsch nicht im selben HTML mit einem nur clientseitigen Schalter, den die Suchmaschine nicht als getrennte Dokumente holen kann. Jedes Locale braucht eine stabile Adresse. Auf dieser Studio-Site liegt Englisch an der Wurzel; Türkisch, Spanisch und Deutsch tragen ein Präfix.",
          "Jede Seite braucht weiter ein Thema. Die deutsche Leistungs-URL erklärt Leistungen in deutscher Suchsprache. Die englische Überschrift zu kopieren erzeugt vier dünne Seiten, die sich gegenseitig Konkurrenz machen.",
        ],
      },
      {
        heading: "Hreflang muss gegenseitig sein",
        paragraphs: [
          "Jede Sprachversion listet sich selbst und die anderen, plus x-default auf dem Locale, das Sie als Rückfall behandeln. Zeigt Deutsch auf Englisch und Englisch ignoriert Deutsch, ist das Signal unvollständig.",
          "Canonicals zeigen jedes Locale auf sich selbst. Alle Sprachen auf Englisch zu zeigen, erklärt die Übersetzungen zu Kopien. Sie können aus dem Index fallen.",
        ],
      },
      {
        heading: "Suchanfragen sind keine Übersetzungen",
        paragraphs: [
          "In den USA sucht man „custom website design“. Auf Türkisch „özel web sitesi“ oder „web tasarım ajansı“. Auf Deutsch „individuelle Website“ oder „Webdesign Agentur“. Schreiben Sie die Seiten aus dem Marktbrief, nicht aus einer übersetzten Keyword-Tabelle.",
          "METEK-Aufträge mit mehreren Sprachen erzeugen unabhängige Texte. Die Studio-Site folgt derselben Regel. Das ist langsamer als maschinelle Übersetzung und der einzige Weg, die behauptete Anfrage zu beantworten.",
        ],
      },
      {
        heading: "Sitemaps und interne Links",
        paragraphs: [
          "Die XML-Sitemap listet die kanonische URL jedes Locale und xhtml-Alternates dazwischen. Interne Links auf einer deutschen Seite bleiben deutsch, außer Sie schicken bewusst in einen anderen Markt.",
          "Sprachumschalter brauchen crawlbare hrefs, nicht nur Klick-Skripte. Ist der einzige Weg zu /tr/services ein JavaScript-Widget, speichert der Crawler die türkische Seite vielleicht nie.",
        ],
      },
      {
        heading: "Was in den Website-Umfang gehört",
        paragraphs: [
          "Listen Sie Märkte, Standard-Locale, wer jede Sprache schreibt und ob URLs schon existieren. Rebuilds brauchen eine Karte, damit alte Sprachordner nicht 404 liefern.",
          "Reicht jetzt eine Sprache, liefern Sie die gut. Locale später zu ergänzen ist üblich. Vier maschinell übersetzte Hüllen am ersten Tag sind kein mehrsprachiges SEO.",
        ],
      },
    ],
  },
  "custom-admin-panel-vs-crm": {
    title: "Eigenes Admin-Panel oder fertiges CRM",
    excerpt:
      "Wann ein CRM vom Regal reicht, wann Workarounds ein eigenes Panel verlangen und was eine Agentur braucht, damit der Umfang ehrlich bleibt.",
    lead: "Ein CRM bringt fremde Objekte: Kontakte, Deals, Phasen. Ein eigenes Admin-Panel nutzt Ihre: Möbellinien, Zimmertypen, Terminregeln, Content-Felder passend zu öffentlichen Seiten. Der teure Fehler ist das erste zu kaufen, während Sie schon im zweiten leben, und jeden Freitag Tabellen zu exportieren.",
    imageAlt: "Generische Pipeline neben einer zugeschnittenen Betriebsliste",
    sections: [
      {
        heading: "Beginnen Sie beim Freitags-Workaround",
        paragraphs: [
          "Liegt die Wahrheit schon in einer Tabelle, einem Chat oder einem Nebenkalender, ist das lizenzierte CRM nicht das führende System. Eigenarbeit lohnt, wenn diese Umwege der echte Prozess sind.",
          "Füllen die Leute eine übliche Pipeline und die Berichte landen in Meetings, behalten Sie das CRM. Ein genutztes Werkzeug zu ersetzen ist ein anderes Projekt als eines, das gemieden wird.",
        ],
      },
      {
        heading: "Objekte, keine Featurelisten",
        paragraphs: [
          "Listen Sie die Nomen: Angebotspaket, Leistungsdauer, Dienstplan, Artikelentwurf, Händlerstandort. Dann die Verben: freigeben, veröffentlichen, zuweisen, stornieren, exportieren. Bildschirme folgen diesen Listen.",
          "Ein Featurekatalog verzögert diese Arbeit. METEK scoped Panels aus Datensätzen und Aktionen. Anbindungen an die öffentliche Site, WhatsApp oder E-Mail stehen im Umfang, damit das Panel keine Insel bleibt.",
        ],
      },
      {
        heading: "Die öffentliche Site gehört oft in denselben Plan",
        paragraphs: [
          "Ein Angebotsformular, das den Datensatz nicht anlegt, den Vertrieb öffnet, ist ein gebrochener Weg. Liegen beide Flächen im Auftrag, gestalten wir die Felder gemeinsam.",
          "Im Portfolio liegt das Content-Panel eines Herstellers neben der Unternehmenssite. Diese Paarung hilft, wenn Schaufenster und Betriebsoberfläche nötig sind.",
        ],
      },
      {
        heading: "Verantwortung nach dem Launch",
        paragraphs: [
          "Laufende Edits bleiben beim Team. Neue Objekte und Anbindungen bleiben Entwicklung. Schreiben Sie diese Trennung in den Umfang. Ein impliziertes „wir sind immer da“ ist keine Supportpolitik.",
          "Fragen Sie, wer Benutzer anlegt, wer einen Datensatz löscht und wo Sicherungen liegen. Die Antworten gehören neben die Screen-Entwürfe.",
        ],
      },
      {
        heading: "Was vor einer Schätzung zu schicken ist",
        paragraphs: [
          "Ein Screenshot der aktuellen Tabelle oder CRM-Ansicht, die Tagesaufgaben und was nicht verloren gehen darf. Benennen Sie, was draußen bleibt. Buchhaltung und Lager im selben Sprint verzögern meist das Panel, das in diesem Quartal geholfen hätte.",
          "Wenn unsicher, starten Sie beim Operator-Weg, der Sie blockiert. Die Software-Seite dieser Site beschreibt, wie dieses Gespräch läuft.",
        ],
      },
    ],
  },
  "business-website-checklist": {
    title: "Was eine Unternehmenswebsite vor dem Launch braucht",
    excerpt:
      "Launch-Checkliste: Angebot, Beleg, Kontaktweg, Mobil, Titles, Sitemap und wer die Seiten nach Go-live ändern kann.",
    lead: "Eine Unternehmenswebsite hat eine kurze Aufgabenliste. Sie benennt das Angebot, zeigt genug Beleg, um ernst genommen zu werden, und macht den nächsten Schritt am Telefon sichtbar. Alles andere stützt. Launch, wenn diese Aufgaben laufen, nicht wenn jede Dekoration versucht wurde.",
    imageAlt: "Gedruckte Launch-Liste neben einem Telefon mit Kontaktknopf",
    sections: [
      {
        heading: "Das Angebot muss in Sekunden findbar sein",
        paragraphs: [
          "Der erste Screen sagt, was Sie verkaufen und an wen. Ein Slogan, der auf jede Firma der Branche passt, ist kein Angebot. Leistungsseiten tragen je eine Leistung, nicht einen Mix aus allem, was nächstes Jahr dazukommen könnte.",
          "Kann eine fremde Person nicht sagen, ob Sie Schränke montieren, Zimmer buchen oder Software bauen, rettet der Rest der Gestaltung den Besuch nicht.",
        ],
      },
      {
        heading: "Beleg und nächster Schritt",
        paragraphs: [
          "Zeigen Sie Arbeit, Standorte oder Betriebskontext, den ein Käufer prüfen kann. Kontakt, Angebot oder Buchung müssen ohne Suche erreichbar sein. WhatsApp darf neben E-Mail stehen, wenn der Markt so schreibt. Ein Formular, das einen Roman verlangt, ist eine geschlossene Tür.",
          "Testen Sie den Weg auf einem kleinen Telefon und langsamer Leitung. Sitzt der Knopf unter einer Cookie-Wand oder einem Hero-Video, das nie lädt, ist die Site in keinem nützlichen Sinn live.",
        ],
      },
      {
        heading: "Suchzugang ist ein Launch-Punkt",
        paragraphs: [
          "Titles, H1, crawlbare Links, Canonicals, Robots-Regeln und die XML-Sitemap gehören in dieselbe Prüfung wie der visuelle Durchgang. Ein Staging-noindex auf Produktion ist ein üblicher Weg, eine Site zu „launchen“, die Google nicht speichert.",
          "Rebuilds brauchen Redirects. Unser technischer SEO-Check geht diese Prüfung der Reihe nach. Führen Sie ihn gegen die Produktionsdomain, nicht nur gegen Staging.",
        ],
      },
      {
        heading: "Jemand muss den Text ändern können",
        paragraphs: [
          "Leistungen, Zeiten, Namen wechseln. Entscheiden Sie, welche Felder das Team pflegt und welche Änderungen Entwicklung brauchen. Eine schöne Site, die für eine Telefonnummer ein Agentur-Ticket braucht, verrottet.",
          "Braucht das Team ein Panel, scoped die Felder, die es wirklich anfasst. Ein generisches CMS mit zweihundert ungenutzten Modulen ist keine Verantwortung.",
        ],
      },
      {
        heading: "Diese Liste in den Brief",
        paragraphs: [
          "Klarheit des Angebots, Beleg, Kontaktweg, Mobil, Titles und Sitemap, Redirects bei Domain- oder Slugwechsel, Inhaltsverantwortung. Das reicht für den Agenturvergleich.",
          "METEK Digital behandelt diese Punkte als Website-Lieferung, nicht als Extra. Schicken Sie die Liste mit der aktuellen Site und der Handlung, die Besuchende abschließen sollen.",
        ],
      },
    ],
  },
  "website-redesign-keep-seo": {
    title: "Website-Relaunch ohne SEO-Verlust",
    excerpt:
      "Unternehmenswebsite neu bauen, ohne indexierte URLs zu verwerfen: Inventar, Redirects, Canonicals, Titles und eine Sitemap der Endadressen.",
    lead: "Ein Relaunch kann vorhandene Sichtbarkeit halten, wenn die neue Site alte Adressen erbt oder sie vor dem Launch per Redirect zuordnet. Der bekannte Fehler: neue Slugs, keine 301, interne Links noch auf Staging, eine Sitemap voller 404. Die Gestaltung sitzt dann auf einem kaputten Crawl.",
    imageAlt: "Alte und neue Website-Ausdrucke mit Pfeilen zwischen URLs",
    sections: [
      {
        heading: "Inventarisieren Sie URLs, die schon funktionieren",
        paragraphs: [
          "Exportieren Sie die aktuelle Sitemap, Search-Console-Seiten und URLs mit nützlichen Anfragen. Notieren Sie Titles und ob die Seite Leistung, Standort, Artikel oder Utility ist. Diese Liste ist das Gedächtnis des Rebuilds.",
          "Entscheiden Sie, welche URLs identisch bleiben. Stabilität ist billiger als ein cleveres neues Ordnerschema. Ändern Sie einen Slug nur, wenn der alte Pfad die Seite falsch darstellt.",
        ],
      },
      {
        heading: "Redirects sind Lieferung, kein Gefallen",
        paragraphs: [
          "Jede aufgegebene URL braucht einen einzelnen 301 zum nächsten Äquivalent, keine Kette und keinen Homepage-Dump. Testen Sie Schleifen. Ziehen Sie interne Links auf die Endadresse.",
          "Canonicals müssen zu dieser Endadresse passen, inklusive https und dem Host, den Sie wirklich ausliefern. Ein Canonical auf www, während die Site auf dem Apex lebt, teilt das Signal.",
        ],
      },
      {
        heading: "Das Thema wichtiger Seiten behalten",
        paragraphs: [
          "Rankt eine Seite zu Schrankmontage, muss der Ersatz weiter davon handeln. Fünf Leistungsseiten zu einem „was wir tun“-Klumpen zu mergen, macht jede Anfrage schwerer treffbar.",
          "Titles und H1 dürfen klarer geschrieben werden. Sie dürfen nicht zu einem Slogan werden, der die Arbeit nicht mehr nennt.",
        ],
      },
      {
        heading: "Saubere Sitemap auf dem Produktionshost",
        paragraphs: [
          "Die XML-Sitemap listet kanonische, indexierbare URLs der Live-Domain. Entfernen Sie Staging, Danke-Seiten, die nicht indexiert gehören, und alles, das noch umleitet. Nach dem Cutover einreichen und prüfen, ob wichtige URLs entdeckt werden.",
          "Mehrsprachige Rebuilds brauchen hreflang auf den neuen Pfaden in derselben Freigabe. Alte Sprachordner neben neuen lebendig zu lassen, erzeugt Duplikate.",
        ],
      },
      {
        heading: "Die Karte in den Agenturumfang",
        paragraphs: [
          "Fragen Sie, wer die URL-Tabelle besitzt, wer Redirects testet und wer Search Console aktualisiert. Beschreibt ein Angebot den Relaunch nur als Screens, ist der SEO-Verlust schon terminiert.",
          "METEK legt diese technische Arbeit in Rebuilds. Schicken Sie die aktuelle Sitemap mit der Anfrage, wenn Sie schon von Suchtraffic abhängen.",
        ],
      },
    ],
  },
  "custom-website-vs-template": {
    title: "Individuelle Website oder Theme: welches Produkt Sie kaufen",
    excerpt:
      "Der Unterschied zwischen einer individuellen Unternehmenswebsite und einem Marketplace-Theme: Designverantwortung, Verkaufsweg, technisches SEO und was sich nach dem Launch ändern lässt.",
    lead: "Ein Theme ist ein Layout, das jemand für eine generische Firma gezeichnet hat. Eine individuelle Website ist ein Interface um Ihr Angebot, Ihren Beleg und die Handlung, die ein Besuch abschließen muss. Beides lässt sich im Netz veröffentlichen. Es ist nicht derselbe Kauf. Die Sprache in einem Angebot zu mischen, führt günstige Zahlen und teure Reue zusammen.",
    imageAlt: "Generisches Rasterschema neben einer gezeichneten Leistungsseite",
    sections: [
      {
        heading: "Themes unterstellen einen Verkaufsweg, den Sie vielleicht nicht haben",
        paragraphs: [
          "Die meisten erwarten Blog, Shop oder einen Hero mit drei Icons. Ein Hersteller, der aus Projektfotos anbietet, oder eine Praxis, die nach Personalzeiten bucht, gibt das Budget für Plugins, Extra-Seiten und CSS aus, das beim nächsten Update bricht.",
          "Individualarbeit startet bei der Handlung. Anbieten, buchen, anrufen, Katalog. Navigation und Seitentypen folgen. Interne Komponenten werden weiterverwendet. Die Informationsarchitektur eines Fremden nicht.",
        ],
      },
      {
        heading: "Verantwortung nach der Rechnung",
        paragraphs: [
          "Fragen Sie, wer Texte, Titles und Bilder ohne die ursprüngliche Gestalterin ändern kann. Theme-Lock-in heißt oft ein Page-Builder, den das Team scheut, oder ein Entwickler-Ticket für eine Telefonnummer.",
          "Eine individuelle Lieferung lässt einen begrenzten, offensichtlichen Editierweg oder ein kleines Panel. METEK baut diese Felder, wenn das Team sie nutzt, nicht ein CMS mit jedem Modul an.",
        ],
      },
      {
        heading: "Suchmaschinen lesen die Seite, nicht den Theme-Namen",
        paragraphs: [
          "Themes kommen mit doppelten Titles, dünnen Leistungsblöcken und Crawl-Fallen in Tag-Archiven. Das zu säubern ist echte Arbeit. Es als „SEO inklusive“ zu zählen, weil ein Plugin da ist, ist nicht dieselbe Arbeit.",
          "Individuelle Sites brauchen weiter Titles, Überschriften, Sitemap und crawlbare Links. Der Unterschied: Diese Felder sitzen in den Templates, die Sie wirklich veröffentlichen, statt nach einem Theme-Update bekämpft zu werden.",
        ],
      },
      {
        heading: "Wann eine kleinere individuelle Site ein großes Theme schlägt",
        paragraphs: [
          "Fünf einzigartige Seiten, die das Angebot erklären und eine vollständige Anfrage sammeln, schlagen ein zwanzigseitiges Theme, das das Team nicht pflegt. Kürzen Sie die Seitenliste auf den Weg, der Geschäft bringt. Artikel oder weitere Märkte, wenn Sie etwas zu sagen haben.",
          "Eine temporäre Landingpage darf auf einem einfachen Stack bleiben. Ärger beginnt, wenn diese Landing als dauerhafte Plattform der Firma verkauft wird.",
        ],
      },
      {
        heading: "Vergleichen Sie Angebote an derselben Liste",
        paragraphs: [
          "Eigene Layouts gegen Theme, Inhaltsverantwortung, Redirects bei vorhandenen URLs, technische SEO-Felder, wer bei der Übergabe verantwortlich ist. Unser Preis-Beitrag erklärt, warum die Zahl wandert, wenn diese Zeilen wechseln.",
          "Wollen Sie den individuellen Weg, beschreiben Sie das Geschäft und die Besucherhandlung. Das reicht, um zu sehen, ob METEK das passende Studio ist.",
        ],
      },
    ],
  },
